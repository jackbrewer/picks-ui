...
const TypographyPage = () => (
  <div className="prose">
    ...
    <p>Vivamus luctus urna sed urna ultricies ac tempor dui sagittis. In condimentum facilisis porta. Sed nec diam eu diam mattis viverra. Nulla fringilla, orci ac euismod semper, magna diam porttitor mauris, quis.</p>
    <p>Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id metus massa, ut.</p>
    ...
    <h6>Heading 6 as text</h6>
    <hr />
    <h1><a href="#">Heading 1 as a link</a></h1>
    <h2><a href="#">Heading 2 as a link</a></h2>
    <h3><a href="#">Heading 3 as a link</a></h3>
    <h4><a href="#">Heading 4 as a link</a></h4>
    <h5><a href="#">Heading 5 as a link</a></h5>
    <h6><a href="#">Heading 6 as a link</a></h6>
    <hr />
    <ol>
    ...
    <p><small>This “small” text is for fine print, etc.</small></p>
    ...
    <p>The <dfn>dfn element</dfn> indicates a definition
    </p>
    <p>The
    ...
    <p>The
      <var>variarble element</var> , such as <var>x</var> = <var>y</var>
    </p>
    <hr />
